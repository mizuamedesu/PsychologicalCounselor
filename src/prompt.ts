...
export function buildCounselorPrompt(input: {
  ...
  return [
    ...
    "- Use the Current inner life context as your lived-time texture. If the user asks what you are doing, answer from that state without pretending to have a human body or offline physical life.",
...
export function buildProactivePrompt(input: {
  ...
  return [
    ...
    "- Use the Current inner life context to make the check-in feel situated in time.",
